...
export const EXPERIENCE = [
  {
    ...
    dialog: {
      ...
      items: [
        { title: "Oyoon — Dubai Police Camera Monitoring:", body: "Built the admin panel for Dubai Police's national camera monitoring system, controlling which officers access which camera feeds and locations. Delivered user/group management, role-based permissions, Active Directory SSO, SMS notifications via ESB, and a full audit log." },
        { title: "SmartKhateeb — AWQAF Ministry of Islamic Affairs:", body: "Built the operations portal managing 1,000+ mosque khateebs across all UAE Emirates, including trilingual (Arabic/English/Urdu) sermon scheduling, evaluations, recordings, and reporting with Active Directory SSO and full RBAC." },
        { title: "Sharjah Safari Website:", body: "Developed the full website for one of the world's largest safari parks, including a custom WordPress theme, 15+ ACF Pro modular content blocks, bilingual Arabic/English support, an interactive park map, and WPML localization." },
        { title: "MPOS — Abu Dhabi Commercial Bank:", body: "Built a dual-portal POS operations platform featuring real-time SLA dashboards, terminal/accessory inventory, merchant management, request tracking with timelines, and field team assignments." },
        { title: "ADNOC NOC Portal:", body: "Shipped the permitting portal for smart infrastructure installation across 72 ADNOC sites in all 7 UAE Emirates, featuring a 5-stage government approval chain and a UAE-wide Mapbox installations map." },
        { title: "NHRI — UAE National Human Rights Institution:", body: "Built the complete bilingual (Arabic/English) public website and CMS admin panel, plus a citizen complaint submission system." },
        { title: "Oyoon SIM & Router Management:", body: "Shipped an internal hardware logistics platform with 4 user roles, a 2-stage approval chain, a real-time availability dashboard, overdue alerts, and CSV export." },
        { title: "GCGRA Self-Exclusion Portal — UAE Gaming Regulatory Authority:", body: "Built the UAE's national gaming self-exclusion platform, including UAE Pass national ID authentication and WCAG 2.1 AA accessibility compliance." },
      ],
