...
export const NEELESH_PROFILE = {
  ...
  linkedin: "linkedin.com/in/neelesh-mishra-6b5066108",
  github: "github.com/nmish2202",
...
export const ANALYZER_TEMPLATES = {
  ...
  "ai-powered-dev":
    "Seeking a Full Stack Engineer who can boost engineering productivity using AI agents and AI-assisted development tools (Cursor, Copilot, agentic workflows), while maintaining strong security practices, code quality, and sound system architecture. Experience with prompt engineering, agentic AI, and modern AI-powered development workflows is highly valued.",
};
...
export const CHAT_QA = [
  ...
  {
    pattern: /(contact|phone|email|linked|github|website|reach|call|write|address)/i,
    reply: `You can reach Neelesh Mishra via:<br>
            • <strong>Website:</strong> <a href="https://${NEELESH_PROFILE.website}" target="_blank">${NEELESH_PROFILE.website}</a><br>
            ...
            • <strong>GitHub:</strong> <a href="https://${NEELESH_PROFILE.github}" target="_blank">${NEELESH_PROFILE.github}</a><br>
...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    dialog: {
      ...
      timeline: "June 2021 - November 2022 (1 year 5 months)",
  ...
  },
  {
    ...
    dialog: {
      ...
      timeline: "October 2017 - May 2021 (3 years 7 months)",
      location: "Noida, Uttar Pradesh, India",
      sectionTitle: "Key Focus Areas & Impact:",
      items: [
